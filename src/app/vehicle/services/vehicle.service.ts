...
export class VehicleService {
  ...
  private selectedVehicleBS = new BehaviorSubject<Vehicle | undefined>(undefined);

  refresh$ = this.refreshBS.asObservable();
  selectedVehicle$ = this.selectedVehicleBS.asObservable();
  ...
  selectVehicle(vehicle: Vehicle) {
    this.selectedVehicleBS.next(vehicle);
  }
  refresh() {
  ...
  results: [
    {
      ...
      pilots: [],
      films: ['https://swapi.py4e.com/api/films/1/', 'https://swapi.py4e.com/api/films/5/'],
    ...
    },
    {
      ...
      pilots: ['https://swapi.py4e.com/api/people/1/', 'https://swapi.py4e.com/api/people/18/'],
